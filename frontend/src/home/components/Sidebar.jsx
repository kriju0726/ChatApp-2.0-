          ...
          <>
            {chatUser.map((user, index) => (
              <div key={user._id}>
                ...
                >
                  {/* <div className={`avatar relative ${isOnline[index] ? "after:content-[''] after:w-3 after:h-3 after:bg-green-500 after:rounded-full after:absolute after:bottom-0 after:right-0 after:border-2 after:border-white" : ""}`}>
                    <div className="w-12 rounded-full overflow-hidden">
                  ...
                  <div>
                    ...
                    <div className="rounded-full bg-green-700 text-sm text-white px-[6px]">+1</div>:<></>
                    }
                  </div> */}
